 ...
 \  \        /  \        /  /
  \__|      |    |      |__/
    ...
    while (gameRunning) {
        ...
        if (room == 1 && newRoomEntered) {
            cout << goblinArt << endl;
            cout << "There is a goblin here. ";
            enemyHealth = 1;
            newRoomEntered = false;
            cout << "Enemy health is now: " << enemyHealth << endl;

        }
        else if (room == 4 && newRoomEntered) {
            cout << rockArt << endl;
        ...
        else if (room == 8 && newRoomEntered) { // Assuming room 8 is the boss room
            cout << dragonArt << endl;
        ...
        if (action == "quit") {
            ...
            if (attackOutcome == 0) {
                ...
                if (enemyHealth <= 0) {
                    cout << "You defeated the enemy!" << endl << endl;
